// Coordinate mappa: centroide di provincia + jitter deterministico.
const PROV = {
...
export const provinceCoords = (prov) => PROV[String(prov || "").toUpperCase()] || [43.0, 12.0];

export function hashHex(s) {
  let h = 2166136261;
...
export function coordsFor(name, province) {
  const base = provinceCoords(province);
